  ...
  sources = {
    ...
    "@informalsystems/quint-0.31.0" = {
      ...
      src = fetchurl {
        ...
        sha512 = "raRl+qhtx7ciL8ZwKSt26XZAJxB4OmbyXCkWsMPJ0f603GbyjBrpE3etdVALRJqhfd8eqoKTxg7VkWSzuQgyCw==";
      };
    };
    ...
    "immutable-4.3.8" = {
      ...
      version = "4.3.8";
      src = fetchurl {
        url = "https://registry.npmjs.org/immutable/-/immutable-4.3.8.tgz";
...
in
{
  ...
  "@informalsystems/quint-language-server" = nodeEnv.buildNodePackage {
    ...
    src = fetchurl {
      ...
      sha512 = "ZUw8iXufhyy4+/LQWJ6e7yjvmUZeu8zslG9EUyL0AftoZ751m6+uX5n0kqWAbTPq5KbE3ch8cz1zc83K7QOMUw==";
    };
    dependencies = [
      (sources."@grpc/grpc-js-1.14.3" // {
        dependencies = [
      ...
      sources."@grpc/proto-loader-0.7.15"
      sources."@informalsystems/quint-0.31.0"
      sources."@js-sdsl/ordered-map-4.4.2"
      sources."@octokit/endpoint-9.0.6"
      sources."@octokit/openapi-types-24.2.0"
      sources."@octokit/request-8.4.1"
